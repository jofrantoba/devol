...
public class GridRecaudado extends DataGrid<AmortizacionProxy> {
			...
			new IFilter<AmortizacionProxy>() {
				...
				public boolean isValid(AmortizacionProxy value, String filter) {
					...
					String values = value.getBeanPrestamo().getNombre().toLowerCase() + " "
							+ value.getBeanPrestamo().getApellido().toLowerCase() + " "
							+ value.getBeanPrestamo().getDni() + " " + fmt.format(value.getFecha()) + " "
							+ value.getMonto();
	...
	private void sortColumns(){
    	...
    	sortHandler.setComparator(cliente, new Comparator<AmortizacionProxy>() {
  	      @Override
  	      public int compare(AmortizacionProxy o1, AmortizacionProxy o2) {
  	    	String cliente1=o1.getBeanPrestamo().getNombre() + " " + o1.getBeanPrestamo().getApellido();
  	    	String cliente2=o2.getBeanPrestamo().getNombre() + " " + o2.getBeanPrestamo().getApellido();
	...
	private Column<AmortizacionProxy, String> cliente = new Column<AmortizacionProxy, String>(new TextCell()) {
	...
	private Column<AmortizacionProxy, Date> fecha = new Column<AmortizacionProxy, Date>(new DateCell(fmt)) {
	...
	private Column<AmortizacionProxy, Number> monto = new Column<AmortizacionProxy, Number>(new NumberCell()) {
