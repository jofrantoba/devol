...
public class CheckboxCellRow extends AbstractEditableCell<Boolean, Boolean> {
	   ...
	   */
	  @Deprecated
	  public CheckboxCellRow(boolean isSelectBox) {
	   ...
	   */
	  public CheckboxCellRow(boolean dependsOnSelection, boolean handlesSelection) {
